...
const StyledSVG = styled.svg`
  ...
  path.fadeIn {
    ...
    animation-delay: 1s; /* om du har en delay */
  }
  ...
  path.revealDown {
    ...
    animation: ${revealTopToBottom} 0.8s ease-out forwards;
    animation-delay: 1.5s;
  }
  path.revealUp {
    clip-path: inset(0 0 100% 0);
    animation: ${revealBottomToTop} 0.8s ease-out forwards;
    animation-delay: 2s;
  }
  ...
  path.pop {
    ...
    animation-delay: 0.5s; /* justera efter behov */
  }
  ...
  path.slideRotateInRight {
    ...
    opacity: 0;
    /* Animation */
    animation: ${slideRotateInRight} 1s ease-out forwards;
    animation-delay: 1s; /* justera när den ska starta */
  }
  ...
  path.slideRotateInLeft {
    ...
    animation: ${slideRotateInLeft} 1s ease-out forwards;
    animation-delay: 1s; /* justera när den ska starta */
  }
  ...
  path:nth-of-type(1) {
    animation-delay: 1s; //GulKUB
  }
  path:nth-of-type(2) {
    animation-delay: 3s; // lilla halvcirkeln ocan för röd
  }
  path:nth-of-type(3) {
    animation-delay: 1s; //Halvcirkeln i gula kuben
  }
  path:nth-of-type(4) {
    animation-delay: 4s; //ORMEN
  }
  path:nth-of-type(5) {
    animation-delay: 2s; //Röd kub
  }
  path:nth-of-type(6) {
    animation-delay: 2s; //ORANGE KUB
  }
  path:nth-of-type(7) {
    //halvcirkel neråt
    animation-delay: 2s;
...
const HeroAnimation = () => (
  <StyledSVG viewBox='0 0 853 381' xmlns='http://www.w3.org/2000/svg'>
    ...
    />
    <path
      className='slideRotateInLeft'
      d='M356 101H587V295H356V101Z'
      fill='#FF7300'
    />
    <path className='revealUp' d='M587 177H786V376H587V177Z' fill='#FFBF00' />
    <path
      className='fadeIn'
      fillRule='evenodd'
      clipRule='evenodd'
